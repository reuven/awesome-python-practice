...
*Maintained by [Reuven Lerner](https://lernerpython.com/). A few entries here are resources I created — Python Workout, Pandas Workout, and Bamboo Weekly — included because they fit, alongside many I didn't. Suggestions and pull requests for anything I've missed are very welcome.*

## Contents

- [Interactive platforms](#interactive-platforms)
- [Coding challenges & competitive programming](#coding-challenges--competitive-programming)
- [Katas & deliberate practice](#katas--deliberate-practice)
...
Found a great Python practice resource that isn't here? Please open a pull request: see [CONTRIBUTING.md](CONTRIBUTING.md). In short: keep entries genuinely useful, add them to the right section in the existing format, and write a short, neutral description.
